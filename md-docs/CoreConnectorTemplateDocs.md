...
- `api-sepc`: This folder contains the api specification files that specify the api formats, request and response payloads. [learn more](/md-docs/RoutingAndApiSpecifications.md)
- `core-connector-svc`: This folder contains code that handles the way the api is exposed over a RESTFUL interface.[learn more](/md-docs/Service.md)
...
- Implement a client for the core banking api. [learn more](/md-docs/CBSClient.md)
- Refactor the aggregate function for `transfers` to perform the tasks as listed above and prepare a response for the mojaloop connector as specified in the mojaloop connector backend api [learn more](/md-docs/CoreConnectorAggregate.md#transfers)
- Write unit and integration tests to verify the functionality [lean more](/md-docs/Testing.md)
...
- Implement the client for the core banking api and make sure it supports transfering funds to the customer's account. [learn more](/md-docs/CBSClient.md)
- Refactor the aggregate function for the `putNotification` to perform the task of checking transfer state and crediting funds into the customer's account. [learn more](/md-docs/CoreConnectorAggregate.md#put-transfer-notification)
...
To implement this functionality in the core connector, the following need to be done;
- Read through the [mojaloop connector client](/md-docs/SDKClient.md) to understand how to use it.
- Read through the aggregate function that executes this function. [learn more](/md-docs/CoreConnectorAggregate.md#send-money)
