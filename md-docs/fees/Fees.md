...
1. **P2P (peer-to-peer): Send Money** <br> Fees are deducted before.<br> DRPP Send Money Amount = Amount - Fee
1. **P2B (peer-to-business): Merchant Payment** <br> Fee is added before presenting terms to customer. <br> You will need to pay = DRPP Source Amount + Fee.
